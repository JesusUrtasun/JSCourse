...
Find the content of the course:
  ...
  [https://github.com/JesusUrtasun/JSCourse](https://github.com/JesusUrtasun/JSCourse)
...
- `visual studio code`: The one I recommend. More information at (https://code.visualstudio.com/)

For running the `.js` files use node.  More information at (https://nodejs.org/es/)
...
```bash
~$ git clone https://github.com/JesusUrtasun/JSCourse.git
```
